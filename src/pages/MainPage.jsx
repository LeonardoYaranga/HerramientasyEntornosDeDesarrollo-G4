...
import fondo from '../assets/FondoMiaw.png';
import { FaCat, FaSmile, FaLeaf, FaHeart, FaPaw, FaUserFriends } from 'react-icons/fa';
    ...
    return (
        <div>
            ...
            <div class="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
                ...
                <h2 class="font-bold text-3xl leading-[1.1] sm:text-3xl md:text-6xl">Miaw</h2>
            ...
            <div class="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
                ...
                <div
                    ...
                    <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
                        ...
                        <div class="space-y-2">
                            <FaSmile className="text-3xl text-teal-600" />
                ...
                <div
                    ...
                    <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
                        ...
                        <div class="space-y-2">
                            <FaUserFriends className="text-3xl text-teal-600" />
